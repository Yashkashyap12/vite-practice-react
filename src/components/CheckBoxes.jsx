  ...
  return (
    <>
      <div className="max-w-xl mx-auto mt-10 p-6 bg-white shadow-xl rounded-2xl">
        ...
        <h1 className="text-2xl mt-5 text-center text-gray-700">
          Select Practice
        </h1>
        <div className="justify-center items-center flex mt-5 gap-6 text-xl">
          ...
          />
          <label htmlFor="c#" className="text-gray-600">
            C#
          </label>
          <input
            onChange={handleSelect}
            ...
            className="accent-blue-600 scale-125"
          />
          <label htmlFor="react" className="text-gray-600">
            React
          </label>
          <input
            onChange={handleSelect}
            ...
            className="accent-blue-600 scale-125"
          />
          <label htmlFor="next" className="text-gray-600">
            Next
          </label>
        </div>
        <h2 className="text-lg text-center mt-4 text-blue-700 font-medium">
          {select.toString()}
        </h2>
      </div>
      ...
      <div className="max-w-xl mx-auto mt-10 p-6 bg-white shadow-xl rounded-2xl">
        ...
        <h2 className="text-xl mt-4 text-center text-pink-600 font-medium">
      ...
      <div className="max-w-xl mx-auto mt-10 p-6 bg-white shadow-xl rounded-2xl">
        ...
        <h2 className="text-center text-lg mt-5 text-green-600 font-medium">
          Selected City : {city}
        </h2>
      </div>
    </>
